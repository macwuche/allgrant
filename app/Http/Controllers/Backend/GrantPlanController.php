...
class GrantPlanController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'application_charge_text' => 'nullable|string|max:1000',
            'commission_charge' => 'required',
            'commission_charge_type' => 'required',
            'commission_charge_text' => 'nullable|string|max:1000',
        ...
        $data = [
            ...
            'application_charge_text' => $request->get('application_charge_text'),
            'commission_charge' => $request->float('commission_charge'),
            'commission_charge_type' => $request->get('commission_charge_type'),
            'commission_charge_text' => $request->get('commission_charge_text'),
