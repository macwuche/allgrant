                ...
                <div class="col-xl-8 col-lg-12 col-md-12">
                    <div class="site-card">
                        <div class="site-card-body">
                            <form action="{{route('admin.plan.grant.update',$plan->id)}}" method="post"
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="prcntcurr">
                                                <select name="grant_fee_type" class="form-select" id="">
                                                    <option @selected($plan->grant_fee_type == 'percentage') value="percentage">
                                                        %
                                                    </option>
                                ...
                                <div class="col-xl-12">
                                    <div class="site-input-groups fw-normal">
                                        <label for="" class="box-input-label">{{ __('Grant Instructions:') }}</label>
