                ...
                <div class="row">
                    <div class="col">
                        <div class="title-content">
                            <h2 class="title">{{ __('Grant Plans') }}</h2>
                            @can('grant-create')
                                <a href="{{ route('admin.plan.grant.create') }}" class="title-btn">
                                    ...
                                    <tbody>
                                        @foreach ($plans as $plan)
                                            <tr>
                                                ...
                                                <td>
                                                    @can('grant-plan-edit')
                                                        <a href="{{ route('admin.plan.grant.edit', $plan->id) }}"
                                                            class="round-icon-btn primary-btn">
                                                            <i data-lucide="edit-3"></i>
                                                        </a>
                                                    @endcan
                                                    @can('grant-plan-delete')
    ...
    <script>
        (function($) {
            ...
            $('body').on('click', '#deleteModal', function() {
                ...
                $('#data-name').html(name);
                var url = '{{ route('admin.plan.grant.destroy', ':id') }}';
