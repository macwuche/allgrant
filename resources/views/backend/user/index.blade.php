                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    @canany(['customer-mail-send','customer-edit','customer-basic-manage','customer-balance-add-or-subtract','customer-change-password','all-type-status','customer-delete'])
                                        <th>{{ __('Action') }}</th>
                                    @endcanany
                                </tr>
                            </thead>
