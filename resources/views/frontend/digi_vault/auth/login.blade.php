                        ...
                        <div class="row gy-24">
                            ...
                            <div class="col-xxl-12">
                                <div class="td-form-group has-right-icon">
                                    ...
                                    <div class="input-field">
                                        <input type="password" name="password" class="form-control password-input" id="passo" required>
                                        <span class="input-icon eyeicon" id="eyeicon"><i class="icon-eye-slash"></i></span>
                                    </div>
                                    <p class="feedback-invalid">{{ __('This field is required') }}</p>
                                </div>
                            </div>
