        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
            <div class="site-card">
                    ...
                    <div class="card-header-links">
                        <div class="d-flex">
                            ...
                            <a href="javascript:void(0)" class="card-header-link" data-bs-toggle="modal"
                                data-bs-target="#bankStatement">
                                <i data-lucide="file-text"></i>{{ __('Bank Statement') }}
                            </a>
                        </div>
                    </div>
                </div>
                <div class="site-card-body p-0 overflow-x-auto">
                    ...
                    <!-- Modal for Bank Statement end-->
                    <div class="modal fade" id="bankStatement" tabindex="-1"
                        aria-labelledby="bankStatementModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-md modal-dialog-centered">
                            <div class="modal-content site-table-modal">
                                <div class="modal-body popup-body">
                                    <button type="button" class="modal-btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"><i data-lucide="x"></i></button>
                                    <div class="popup-body-text">
                                        <div class="title">{{ __('Bank Statement') }}</div>
                                        <form id="bankStatement"
                                            action="{{ route('user.transactions.generate.bank.statement') }}"
                                            ...
                                            <div class="step-details-form">
                                                <div class="row">
                                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                                        <div class="inputs">
                                                            <label for="from_date"
                                                                class="input-label">{{ __('From Date:') }}<span
                                                    ...
                                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                                        <div class="inputs">
                                                            <label for="to_date"
                                                                class="input-label">{{ __('To Date:') }}<span
                                                                    class="required">*</span></label>
                                                            <div class="input-group">
    ...
    @push('js')
        ...
        <script>
            ...
            $(document).on('click', '.details-btn', function(e) {
                ...
                const amountClass = amount.startsWith('+') ? 'green-color' : 'red-color';
                    $('.amount-value')
                        .removeClass('green-color red-color')
                        .addClass('fw-bold ' + amountClass)
                        .text(amount);
                ...
                $.each(transaction, function(key, value) {
                    ...
                    const extension = typeof value === 'string' ? value.split('.').pop().toLowerCase() : '';

                    if (imageExtensions.includes(extension)) {
                        displayValue = `<a href="/assets/${value}" class="nav-link p-0" target="_blank">{{ __('Click here to view image') }}</a>`;
                    } else {
                        displayValue = value;
                    }
                    ...
                    additionalData += `
                        <div class="profile-text-data">
                            <div class="attribute">${capitalizeFirstLetter(key.replaceAll('_', ' '))}</div>
