    ...
    <div class="row">
        <div class="col-xl-7 col-lg-7 col-md-7">
            <div class="site-card">
                ...
                <div class="site-card-body">
                    <form action="{{ route('user.grant.subscribe') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="grant_id" value="{{ encrypt($plan->id) }}">
                        ...
                        <div class="step-details-form mb-4">
                            ...
                            @endforeach
                            <button
                                @if (auth()->user()->passcode !== null && setting('grant_passcode_status')) type="button"
                        ...
                        @if (auth()->user()->passcode !== null && setting('grant_passcode_status'))
        ...
        <div class="col-xl-5 col-lg-5 col-md-5">
            <div class="site-card mb-2">
                <div class="site-card-header">
                    <div class="title-small">{{ __('Grant Instructions') }}</div>
                </div>
                <div class="site-card-body">
                    {!! $plan->instructions !!}
                </div>
                ...
                <div class="site-card-body p-0">
                    <div class="site-custom-table site-custom-table-sm">
                        <div class="contents">
                            ...
                            <div class="site-table-list">
                                <div class="site-table-col">
                                    <div class="trx fw-bold">{{ __('Grant Amount:') }}</div>
                                </div>
                                <div class="site-table-col">
