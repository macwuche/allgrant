...
@section('content')
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                        ...
                        <div class="card-header-links d-flex">
                            @if ($dps->plan->is_upgrade)
                                <a href="javascript:void(0)" class="card-header-link" data-bs-toggle="modal"
                                    data-bs-target="#increment"><i data-lucide="plus"></i>{{ __('Increase') }}</a>
                            @endif
                            @if ($dps->plan->is_downgrade)
                                <a href="javascript:void(0)" class="bg-danger card-header-link" data-bs-toggle="modal"
                                    data-bs-target="#decrement"><i data-lucide="minus"></i>{{ __('Decrease') }}</a>
                            @endif
                        </div>
                    @endif
                </div>
                    ...
                    <div class="site-custom-table site-custom-table-sm">
                        <div class="contents">
                            ...
                            <div class="site-table-list">
                                ...
                                <div class="site-table-col">
                                    <div class="fw-bold"><span
                                            class="type site-badge badge-primary">{{ $dps->status }}</span></div>
                                </div>
                            </div>
                            <div class="site-table-list">
                                <div class="site-table-col">
                            ...
                            <div class="site-table-list">
                                ...
                                <div class="site-table-col">
                                    <div class="fw-bold">{{ $dps->per_installment . ' ' . $currency }}
                                        ({{ __('Every :interval Days', ['interval' => $dps->plan->interval]) }})
                                    </div>
                                </div>
                            </div>
                            <div class="site-table-list">
                                ...
                                <div class="site-table-col">
                                    <div class="fw-bold">{{ $dps->plan->total_installment }} {{ __('Times') }}</div>
                                </div>
                            </div>
                            <div class="site-table-list">
                                <div class="site-table-col">
                                ...
                                <div class="site-table-col">
                                    <div class="fw-bold"><span
                                            class="type site-badge badge-primary">{{ $dps->given_installment }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="site-table-list">
                            ...
                            <div class="site-table-list">
                                ...
                                <div class="site-table-col">
                                    <div class="red-color fw-bold">{{ $dps->plan->charge }}
                                        {{ $dps->plan->charge_type == 'percentage' ? '%' : $currency }} /
                                        {{ $dps->plan->delay_days }} Day</div>
                                </div>
                            </div>
                            <div class="site-table-list">
                                <div class="site-table-col">
                        ...
                        <div class="contents">
                            ...
                            @foreach ($dps->transactions as $trx)
                                <div class="site-table-list">
                                    ...
                                    <div class="site-table-col">
                                        <div class="trx fw-bold">
                                            {{ $trx->given_date != null ? $trx->charge . ' ' . $currency : __('Yet to pay') }}
                                        </div>
                                    </div>
                                    <div class="site-table-col">
            ...
            {{-- DPS Increment --}}
            <div class="modal fade" id="increment" tabindex="-1" aria-labelledby="incrementModalLabel"
                aria-hidden="true">
                                ...
                                <form action="{{ route('user.dps.increment', encrypt($dps->id)) }}" method="POST">
                                    ...
                                    <div class="step-details-form">
                                        <div class="alert alert-info">
                                            <p class="mb-0">{{ __('Current Per Installment Fee') }}:
                                                <b>{{ $dps->per_installment }}</b> {{ $currency }}
                                            </p>
                                        </div>
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12">
                                                <div class="inputs">
                                                    <label for=""
                                                        class="input-label">{{ __('Increase Amount') }}<span
                                                            class="required">*</span></label>
                                                    <div class="input-group">
                                                        <input type="number" min="1" class="form-control"
                                                            name="increase_amount" value="">
                                                        <span class="input-group-text">{{ $currency }}</span>
                                                    </div>
                                                    <div class="input-info-text min-max">
                                                        {{ __('Minimum :minimum_amount and Maximum :maximum_amount', [
                                                            'minimum_amount' => $currencySymbol . $dps->plan->min_increment_amount,
                                                            'maximum_amount' => $currencySymbol . $dps->plan->max_increment_amount,
                                                        ]) }}
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="step-details-form">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12">
                                                <div class="inputs">
                                                    <label for=""
                                                        class="input-label">{{ __('Decrease Amount') }}<span
                                                            class="required">*</span></label>
                                                    <div class="input-group">
                                                        <input type="number" min="1" class="form-control"
                                                    ...
                                                    <div class="input-info-text min-max">
                                                        {{ __('Minimum :minimum_amount and Maximum :maximum_amount', ['minimum_amount' => $currencySymbol . $dps->plan->min_decrement_amount, 'maximum_amount' => $currencySymbol . $dps->plan->max_decrement_amount]) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
